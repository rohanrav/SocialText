...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', id: number, points: number, text: string, title: string, creatorId: number, createdAt: string, updatedAt: string } };
